...
import { navConfig, companyConfig } from '@/config/env';
          ...
          <div className="flex items-center justify-between h-full">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                className="md:hidden w-10 h-10 rounded-full hover:bg-muted transition-colors"
              ...
              <div className="flex flex-col h-full pt-20 px-6">
                ...
                <div className="mt-auto pb-8">
                  <div className="flex items-center gap-3 px-4 py-3 text-muted-foreground">
                    <LogoCompact />
                    <span className="text-sm">{companyConfig.name}</span>
                  </div>
                </div>
              </div>
            </motion.div>
